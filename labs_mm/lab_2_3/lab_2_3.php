<html>
  ...
  <body>
    <?php
      ...
      $G = 73000; // kg - weight
      $al = array(0 => 18, 1 => 24, 2 => 24, 3 => 32); // pers AEwC -  alignment (tsentrovka)
     ...
     $graph_dat = array_fill(0,4,array());
      ...
      for($alignment = 0; $alignment <= 3; $alignment++){
        ...
        echo "<h3 aling=\"left\"> Alignment value = 0." . $al[$alignment] . ", Earth velocity = " . $Wx . ", Traction sector = " . $Dg . "</h3>";
        ...
        $Y[1] = 97.2; // earth velocity 
        $Y[2] = 0; // pitch angle speed
        $Y[3] = 0; // pitch angle
        $Y[4] = 0; // trajectory inclination 
        $Y[5] = 0; // drive (attack) angle
        $Y[6] = 0; // flight level
      ...
      "<table width=\"100%\" cellspacing=\"0\" border=\"1\">
       ...
       <tr>
        <td>$Dv_bal</td><td>-10</td><td>$Dv_ny</td><td>-18.3</td><td>-20</td><td>$T_V</td><td>49</td><td>51</td><td>52</td>
       </tr>
      </table><br/>";
      echo "<h3>M = " . $V / $a_n . "</h3>";
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function draw_chart_a() {
        ...
        data.addColumn('number', 'alignment = 24, Dg');
        data.addColumn('number', 'alignment = 24, Wx');
        ...
        <?php
          ...
          $a3 = file_get_contents("./data3.json");
