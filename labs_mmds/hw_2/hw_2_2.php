    ...
    <?php
        ...
        class LagrangePolynomial {
            ...
            function CreateData() {
                ...
                $graph_dat_file_b = 'data_b_2.json';
                ...
                $graph_dat_file_m = 'data_m_2.json';
            ...
            function InterpolateLagrangePolynomialForModel() {
                ...
                $this->size_m = (($this->size_m_prev) * 2) - 1;
                $t_step = round(((round($this->xValues_m[1], 5) - round($this->xValues_m[0], 5)) / 2), 7);
        ...
        $test = new LagrangePolynomial("./hw_2_data_2.txt");
        $test->ExtractAbsOrds();
   ...
   <body>
      ...
      <script language = "JavaScript">
         function chart_div_b() {
            ...
            data.addRows([
              <?php
                $b = file_get_contents("./data_b_2.json");
                //$m = file_get_contents("./data_m.json");
         ...
         function chart_div_m() {
            ...
            data.addRows([
              <?php
                //$b = file_get_contents("./data_b.json");
                $m = file_get_contents("./data_m_2.json");
                //$json_b = json_decode($b, true);
                $json_m = json_decode($m, true);
